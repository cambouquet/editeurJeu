...
public class InputDialog extends AbstractEasyDialog
{
	...
	/**
	 * Configure la taille des différents champs de saisie
	 * 
	 * Les valeurs attendues sont situées entre 1 et 100. Dans le cas contraire, la taille par défaut est 8.
	 * @param size
    ...
    protected void setElements()
    {
		...
		for (int i = 0; i < titles.length; i++)
		{
			...
			elementsPanel.add(labels[i], new GridBagConstraints(0, i + 1, 1, 1, 1.0,
					0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
					new Insets(5, 20, 5, 10), 0, 0));
			elementsPanel.add(textFields[i], new GridBagConstraints(1, i + 1, 1, 1, 1.0,
