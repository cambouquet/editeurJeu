...
public class RadioDialog extends AbstractEasyDialog
{
	...
	/**
	 * Créé une fenêtre de dialogue contenant des radio boutons avec les titres
	 * demandés, les champs vides.
	 * 
	 * @param parent
	 *        La fenerte parente
	 * @param title
	 ...
	 * @param titres
	 *        Les titres de chaque radio bouton. Autant de radio boutons sont
	 *        créés qu'il y a de titres.
	 */
	...
	/**
	 * Crée une fenêtre de dialogue avec les titres demandÃ©s. Permet de
	 * regrouper les radio boutons par sujet. Pas encore bien pris en compte.
	 * 
	 * @param parent
	 *        La fenêtre parente
	 * @param title
	 ...
	 *        qu'elle n'est pas fermée.
	 * @param titres
	 *        Les titres de chaque radio boutons. Autant de radio boutons sont
	 *        créés qu'il y a de titres.
	 * @param groupes
	 ...
	 * 
	 * @return Le nombre total de groupe
	 */
